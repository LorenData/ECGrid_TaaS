...
def main(inn, out):
    ...
    idocsortorder = inn.get({'BOTSID': 'UNH'}, {'BOTSID': 'BGM', 'C002.1001': None})

    if idocsortorder == '230':
        IHREZ = 'AC'
    elif idocsortorder == '352':
        IHREZ = inn.get({'BOTSID': 'UNH'}, {'BOTSID': 'FTX', '4451': 'ZZZ', 'C107.3055': '92', 'C107.4441': None})
    elif idocsortorder == '220':
        if inn.get({'BOTSID': 'UNH'}, {'BOTSID': 'RFF', 'C506.1153': 'PD', 'C506.1154': None}):
            IHREZ = ''
        else:
            IHREZ = 'A'
    else:
        raise Exception('Geen valide code in BGM.soort order: %s.' % idocsortorder)

    out.put({'BOTSID': 'EDI_DC40'}, {'BOTSID': 'E2EDK01003'}, {'BOTSID': 'E2EDKA1002', 'PARVW': 'AG', 'IHREZ': IHREZ})

    DELIVERYDATE = inn.get({'BOTSID': 'UNH'}, {'BOTSID': 'DTM', 'C507.2005': '2', 'C507.2380': None})
    ...
    for lin in inn.getloop({'BOTSID': 'UNH'}, {'BOTSID': 'LIN'}):
        ...
        lou.put({'BOTSID': 'E2EDP01003'}, {'BOTSID': 'E2EDP20', 'EDATU': DELIVERYDATE})
